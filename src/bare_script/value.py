...
# Save the pure-Python implementations under private aliases so the C
# extension can fall back to them for cases it doesn't fully replicate
# (datetime formatting, JSON serialization, datetime parsing).
_value_type_py = value_type
_value_string_py = value_string
_value_json_py = value_json
_value_boolean_py = value_boolean
_value_is_py = value_is
_value_compare_py = value_compare
_value_round_number_py = value_round_number
_value_parse_number_py = value_parse_number
_value_parse_integer_py = value_parse_integer
_value_parse_datetime_py = value_parse_datetime
_value_normalize_datetime_py = value_normalize_datetime


# Override the public names with the C implementations when the value_c
