...
'''))
        self.assertDictEqual(script, {
            'statements': [
                ...
                {'label': {'name': '__bareScriptDone5'}},
                {'jump': {'label': '__bareScriptLoop3', 'expr': {'variable': 'true'}}},
                {'label': {'name': '__bareScriptDone3'}},
                {'return': {}}
            ]
        })
