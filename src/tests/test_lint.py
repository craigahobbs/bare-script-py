...
from bare_script import lint_script, validate_script
...
class TestLint(unittest.TestCase):
    ...
    def test_lint_script_global_unknown_global_inherited_name(self):
        script = {
            'scriptName': 'test.bare',
            'scriptLines': [
                'a = constructor'
    ...
    def test_lint_script_function_call_inherited_name(self):
        script = {
            'scriptName': 'test.bare',
            'scriptLines': [
                'function testFn():',
    ...
    def test_lint_script_function_unused_variable_proto_name(self):
        script = {
            'scriptName': 'test.bare',
            'scriptLines': [
                'function testFn():',
