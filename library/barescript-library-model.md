...
| xPad       | bool                                                                  | optional                   | If true, the X-axis range is rounded outward to a whole tick step, so that the data does not reach the ends of the axis (default is false). A logarithmic axis always rounds its range outward to whole decades. |
| yPad       | bool                                                                  | optional                   | If true, the Y-axis range is rounded outward to a whole tick step, so that the data does not reach the ends of the axis (default is true). A logarithmic axis always rounds its range outward to whole decades.  |
