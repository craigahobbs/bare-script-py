...
src/bare_script/include_source.py: $(sort $(wildcard src/bare_script/include/*.bare)) | $(DEFAULT_VENV_BUILD)
	$(DEFAULT_VENV_PYTHON) -c "$$INCLUDE_SOURCE_PY" $@ $^
...
for include_path in include_paths:
    ...
    include_text_escaped = include_text.replace('\\', '\\\\').replace("'", "\\'")
    parts.append(f"\n\n# {include_name}.bare\n{constant_name} = '''\\\n{include_text_escaped}'''\n")
